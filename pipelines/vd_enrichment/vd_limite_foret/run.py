#!/usr/bin/env python3
"""vd_limite_foret — canton-VD forest limit polygons. Layer 490."""
import json, sys
...
SOURCE_LAYER = "vd.limite_foret"
TABLE = "bronze_ch.vd_limite_foret"
...
if __name__ == "__main__":
    sys.exit(run_arcgis_parser(
        dataset_code="vd_limite_foret",
        table=TABLE, pk_cols=PK_COLS, columns=COLUMNS,
        layers=[LayerSpec(layer_id=490, source_layer=SOURCE_LAYER)],
        row_mapper=row_mapper,
        parser_module="vd_limite_foret",
    ))
