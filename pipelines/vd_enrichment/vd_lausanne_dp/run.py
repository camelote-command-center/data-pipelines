#!/usr/bin/env python3
"""vd_lausanne_dp — Lausanne WFS bdcad_bf_parc_pol_dp (Domaine Public polygons)."""
import sys
...
TABLE = "bronze_ch.vd_lausanne_dp"
...
if __name__ == "__main__":
    sys.exit(run_wfs_parser(
        dataset_code="vd_lausanne_dp",
        table=TABLE, pk_cols=PK_COLS, columns=COLUMNS,
        layers=[WFSLayerSpec(source_layer="bdcad_bf_parc_pol_dp")],
        row_mapper=row_mapper,
        parser_module="vd_lausanne_dp",
    ))
