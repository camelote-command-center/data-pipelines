...
LAYERS = {
    489: "vd.distance_foret",      # esriGeometryPolyline — LFo art.17 setback lines (6,664)
    166: "vd.reserve_forestiere",  # esriGeometryPolygon  — forest reserves (138)
}
# /490 vd.limite_foret is EXCLUDED: the source returns NO geometry for it (upstream
# defect, bug 41a643b8) while /489 — same polyline type — works fine.
