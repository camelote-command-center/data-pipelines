...
/**
 * Transform a single parsed CSV row into a DVFRecord.
 * Returns null when the row should be skipped (missing id_mutation).
 */
export function transformRow(row: Record<string, string>): DVFRecord | null {
