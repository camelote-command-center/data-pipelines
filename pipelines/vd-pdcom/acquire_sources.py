...
def persist(conn,source,sha,pages):
    ...
    from orbe_thematic import persist as persist_orbe_thematic
    persist_orbe_thematic(conn,doc_id,sha)
    from aigle_thematic import persist as persist_aigle_thematic
    ...
    from prangins_sweep import persist as persist_prangins_sweep
    ...
    from prangins_native_final import persist as persist_prangins_native_final
    persist_prangins_native_final(conn,doc_id,sha)
    from prangins_accompaniment import persist as persist_prangins_accompaniment
