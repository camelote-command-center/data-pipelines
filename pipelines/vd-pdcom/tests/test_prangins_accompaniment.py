...
import prangins_accompaniment as p
class NativeTests(unittest.TestCase):
 ...
 def test_scope(self):self.assertEqual(len(self.b['features']),1);self.assertEqual(len({p.sector_id(f['key']) for f in self.b['features']}),len(self.b['features']))
