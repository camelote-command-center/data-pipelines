...
class ThematicTests(unittest.TestCase):
 ...
 def test_policy_not_reclassified(self):self.reject(lambda b:b['features'][1]['policy_status'].update(state='current_development'))
 ...
 def test_composite_once(self):
  ...
  self.assertEqual(len(self.b['features'][0]['source_paths']),7)
