...
BATCH_SHA='b115d3e8cb81a804715098fa5bc425f19498254b4c06d51dc2563245f1b7d35e'
...
def validate(b):
    ...
    return b
def load_artifacts():
    raw=(Path(__file__).parent/'reports/prangins-native/batch.json').read_bytes()
