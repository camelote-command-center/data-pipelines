...
Display clipping: seven monochrome images extend0.960022PDF points (about4source pixels) beyond the page width. The raw image bounds must not be squeezed to the page rectangle. The exact display transform and clip rectangle are recorded; on rotated pages the overflow falls at the left edge. This was found by the extent check and preserved rather than rescaled away.
