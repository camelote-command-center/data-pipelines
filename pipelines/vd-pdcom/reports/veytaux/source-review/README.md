...
PDF30–31 were visually checked and contain ten adopted council amendments. `case-index.json` links the eleven named cases to their PDF pages and amendments. In particular Sonchaux amendment10 qualifies the development objectives and returns a large part to alpine zoning. PDF29 already incorporates amendment10 wording (verified in the map-assets review); preserve that text alongside the schematic illustration and amendment list. The eleven cases are not eleven validated development polygons.
...
Original map assets, rotation and legend review: see `../map-assets/README.md`.
