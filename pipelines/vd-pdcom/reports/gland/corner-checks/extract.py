...
p=pathlib.Path(__file__).resolve().parent.parent;q=p/'corner-checks';q.mkdir(exist_ok=True)
...
boxes={'west-north':[690,350,765,470],'west-middle':[780,635,855,770],'south-east':[1300,830,1450,920]}
