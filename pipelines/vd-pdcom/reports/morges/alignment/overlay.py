...
fig.suptitle('Morges holdout outliers: magenta source outlines; gray current footprints; blue source centroid');fig.tight_layout();fig.savefig(root/'outlier-review.png',dpi=120);plt.close(fig)
