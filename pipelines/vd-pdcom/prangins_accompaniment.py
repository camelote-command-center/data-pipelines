...
BATCH_SHA='f2aae6dade2f3c6457d5242a0ce7b3319043612bf2e475052bb9e3905ea7b847'
...
def validate(b):
    ...
    return b
def load_artifacts():
    raw=(Path(__file__).parent/'reports/prangins-accompaniment/batch.json').read_bytes()
