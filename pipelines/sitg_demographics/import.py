...
Fetches 9 SITG datasets via ArcGIS REST API and upserts into lamap_db:
  ...
  4. OCS_EMPLOI_COMMUNE             — Employment by commune             (polygon)
  5. OCS_EMPLOI_VGE_SECTEUR         — Employment by sector              (polygon)
  6. OTC_MACARON                    — Parking permit zones              (polygon)
  7. OTC_STATIONNEMENT_V_PUBLIQUE   — Public parking spaces             (polyline)
  8. OTC_AMENAG_2ROUES              — Two-wheel amenities               (polyline)
  9. CAD_PARCELLE_MENSU_HISTO       — Historical cadastral parcels      (polygon)
...
def main():
    ...
    print("=" * 60)
    print("  SITG Demographics Pipeline")
